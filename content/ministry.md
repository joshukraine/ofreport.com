...
description: >-
  ...
  those around us. If you’d like to learn more about how we minister, read on!
---
...
{{< svg name="eto-logo" class="block mb-6 h-auto w-[200px] max-w-full" >}}
...
{{< button text="Visit euroteamoutreach.org" href="https://euroteamoutreach.org/" outline=true external=true align="left" >}}

---

{{< svg name="bible-first" class="block mb-6 h-auto w-[400px] max-w-full" >}}
...
{{< button text="Visit getbiblefirst.com" href="https://getbiblefirst.com/" outline=true external=true align="left" >}}

---

{{< svg name="cmo-logo" class="block mb-6 h-auto w-[250px] max-w-full" >}}
...
{{< button text="Visit cmoproject.org" href="https://cmoproject.org/" outline=true external=true align="left" >}}
