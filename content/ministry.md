...
{{< button text="Visit euroteamoutreach.org" href="https://euroteamoutreach.org/" outline=true external=true >}}

---

{{< svg name="bible-first" class="mx-auto block mb-6 h-auto w-[400px] max-w-full" >}}
...
{{< button text="Visit getbiblefirst.com" href="https://getbiblefirst.com/" outline=true external=true >}}

---

{{< svg name="cmo-logo" class="mx-auto block mb-6 h-auto w-[250px] max-w-full" >}}
...
{{< button text="Visit cmoproject.org" href="https://cmoproject.org/" outline=true external=true >}}
